...
class ClienteJogador:
    ...
    def conectar(self, nome, is_cerebro):
        ...
        self.fila_inputs.queue.clear() # Limpa sujeira do teclado anterior
    ...
    def ouvir_servidor(self):
        # Proteção contra congelamento do Socket
        ...
        while self.conectado:
            try:
                ...
                continue # Continua o loop mantendo o cliente vivo
            except Exception as e:
                break # Sai do loop caso o socket quebre fisicamente
        
        # Só exibe erro de queda e recomeça a eleição se o jogo autorizou a entrada inicial
...
# ==============================================================================
# LEITOR GLOBAL DE TECLADO (Solução de Race Condition)
# ==============================================================================
...
if __name__ == "__main__":
    ...
    # Fila única que evita o "Thread Leak" e digitações duplas
    ...
    while True:
        ...
        # Trava para garantir que a porta 5555 não tenta ser aberta 2 vezes pelo mesmo processo
